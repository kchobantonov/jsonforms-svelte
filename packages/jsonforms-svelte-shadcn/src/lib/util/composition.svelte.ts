...
/**
 * Adds styles, appliedOptions and shadcnProps
 */
export const useShadcnLabel = <
  T extends {
 ...
 */
export const useShadcnArrayControl = <
  T extends {
    label: string;
    required: boolean;
    config: any;
