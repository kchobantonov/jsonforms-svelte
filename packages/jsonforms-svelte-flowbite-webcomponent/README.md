...
<script
  type="module"
  src="https://cdn.jsdelivr.net/npm/@chobantonov/jsonforms-svelte-flowbite-webcomponent@1.0.2/dist/jsonforms-svelte-flowbite.js"
></script>
```
...
<script
  type="module"
  src="https://unpkg.com/@chobantonov/jsonforms-svelte-flowbite-webcomponent@1.0.2/dist/jsonforms-svelte-flowbite.js"
></script>
```
...
<html lang="en">
  ...
  <body>
    ...
    <script type="module">
      import 'https://cdn.jsdelivr.net/npm/@chobantonov/jsonforms-svelte-flowbite-webcomponent@1.0.2/dist/jsonforms-svelte-flowbite.js';
...
await import('@chobantonov/jsonforms-svelte-flowbite-webcomponent');
await customElements.whenDefined('jsonforms-svelte-flowbite');
const form = document.createElement('jsonforms-svelte-flowbite');
form.data = { name: 'Ada' };
```
...
export the type `JsonFormsFlowbiteElement`. The module has no runtime
