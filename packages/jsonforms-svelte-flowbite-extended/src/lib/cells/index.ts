import { DispatchRendererCell } from '@chobantonov/jsonforms-svelte-flowbite';
...
export const flowbiteExtendedCells = [durationCellEntry, fileCellEntry, nullCellEntry];
