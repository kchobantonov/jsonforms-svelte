...
A Vite + TypeScript browser host for `@chobantonov/jsonforms-svelte-editor`. The Integration selector switches between the native Svelte editor and the separate web-component wrapper.
