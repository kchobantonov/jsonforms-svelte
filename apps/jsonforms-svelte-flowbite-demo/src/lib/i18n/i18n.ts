...
export const createTranslator = (
  ...
  if (!localeTranslations && translations) {
    ...
    localeTranslations = dashIndex > 0 ? translations[locale.substring(0, dashIndex)] : undefined;
  }
  ...
  const translate = (
    ...
    const message = localeTranslations ? get(localeTranslations, id) : defaultMessage;
