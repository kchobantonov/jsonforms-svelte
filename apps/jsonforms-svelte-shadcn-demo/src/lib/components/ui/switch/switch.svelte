...
>
  <SwitchPrimitive.Thumb
    ...
    class={cn(
      'pointer-events-none block rounded-full bg-background ring-0 transition-transform group-data-[size=default]/switch:size-4 group-data-[size=sm]/switch:size-3',
      checked
        ? 'translate-x-[calc(100%-2px)] rtl:translate-x-[calc(-100%)] dark:bg-primary-foreground'
